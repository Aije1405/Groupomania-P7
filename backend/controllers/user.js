...
exports.signup = (req, res, next) => {
  ...
  bcrypt
    .hash(req.body.password, 10) //hachage du password et 10 passages de salage
    .then((hash) =>     {
        ...
        const queryUsers = "INSERT INTO users (firstname, lastname, email, password, position, department) VALUES (?, ?, ?, ?, ?, ?)";
        const insertUsers = [firstname, lastname, email, password, position, department];
